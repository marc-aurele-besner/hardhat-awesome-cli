...
- 32242ab: Cover the interactive menu flows that were untested before `serveInquirer.ts` was split (#155). Adds a shared `test/menus-test-helpers.ts` inquirer stub plus four new menu-level test files driven by scripted `inquirer.prompt` answers:
