...
contract MockERC1155Upgradeable is ERC1155Upgradeable {
    ...
    function __MockERC1155Upgradeable_init(string memory name_, string memory symbol_, string memory uri_) internal onlyInitializing {
        __MockERC1155Upgradeable_init_unchained(name_, symbol_, uri_);
    }

    function __MockERC1155Upgradeable_init_unchained(string memory name_, string memory symbol_, string memory uri_) internal onlyInitializing {
        __ERC1155_init(uri_);
        _name = name_;
        _symbol = symbol_;
    }
