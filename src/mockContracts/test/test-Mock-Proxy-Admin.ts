...
let proxy: any
let logicContract: string
let proxyAdminContract: string
let deployer: any
let user1: any
...
describe('MockProxyAdmin', function () {
    ...
    it('Should upgrade the proxy and invoke a function via upgradeAndCall', async function () {
        ...
        // The initializer selector for ERC20Upgradeable: initialize(string,string)
        ...
        const callData = MockERC20UpgradeableFactory.interface.encodeFunctionData(fragment, [
            'UpgradedToken',
            'UPG'
        ])
